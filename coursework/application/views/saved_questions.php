...
<body>
    ...
    <div class="app-container">
        ...
        <div class="app-sidebar">
                ...
                <a href="<?php echo site_url('savedQuestions/index'); ?>" class="app-sidebar-link active" title="Saved questions">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
			...
			<div class="projects-section">
                ...
                <div class="project-boxes jsGridView">
                    <!-- Display a list of saved questions for the user -->
                            ...
                            <div class="project-box">
                                ...
                                <div class="project-box-content-header">
                                    <a href="<?php echo site_url('question/view/' . $question['question_id']); ?>">
                                        <p class="box-content-header"><?php echo substr($question['title'], 0, 45) . (strlen($question['title']) > 45 ? '...' : ''); ?></p>
                                    </a>									
                                    <p class="box-content-subheader"><?php echo substr($question['content'], 0, 100) . (strlen($question['content']) > 100 ? '...' : ''); ?></p>
