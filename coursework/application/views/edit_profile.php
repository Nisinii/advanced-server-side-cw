			...
			<div class="projects-section">
                ...
                <div class="project-boxes jsGridView">
                    <div class="project-box-wrapper">
                        <?php echo form_open('profileController/updateDetails'); ?>

                            <div class="form-group">
                                <label for="display_name">Display Name</label>
                                <input type="text" id="display_name" name="display_name" class="form-control" value="<?php echo isset($userDetails['display_name']) ? htmlspecialchars($userDetails['display_name']) : ''; ?>">
                            </div>

                            <div class="form-group">
                                <label for="title">Title</label>
                                <input type="text" id="title" name="title" class="form-control" value="<?php echo isset($userDetails['title']) ? htmlspecialchars($userDetails['title']) : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="bio">Bio</label>
                                <textarea id="bio" name="bio" class="form-control" required><?php echo isset($userDetails['bio']) ? htmlspecialchars($userDetails['bio']) : ''; ?></textarea>
                            </div>
                    ...
                    <div class="project-box-wrapper">
                        <div class="image">
                            <img src="<?php echo base_url('assets/images/questions.jpg'); ?>" alt="Description of the image">
                        </div>
                    </div>
                </div>
