			...
			<div class="projects-section">
                ...
                <div class="project-boxes jsGridView">
                    <div class="project-box-wrapper">
                        <?php echo form_open('profileController/updateQuestion/' . $question['question_id']); ?>

                            <div class="form-group">
                                <label for="title">Title:</label>
                                <p class="form-info">Be specific and imagine you're asking a question to another person. Minimum 50 characters.</p>
                                <input type="text" name="title" class="form-control" value="<?php echo $question['title']; ?>" required>
                            </div>

                            <div class="form-group">
                                <label for="content">Content:</label>
                                <p class="form-info">Introduce the problem and expand on what you put in the title. Minimum 100 characters.</p>
                                <textarea name="content" class="form-control" required><?php echo $question['content']; ?></textarea>
                            </div>
