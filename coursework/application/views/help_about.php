...
<head>
	...
	* {
	...
	.cards-container .owl-carousel1 .card .card-img-top {
		max-width: 50px;
		border-radius: 50%;
    ...
    <div class="app-container">
        ...
        <div class="app-content">
		    <div class="app-sidebar">
                ...
                <a href="<?php echo site_url('tags/index'); ?>" class="app-sidebar-link" title="Tags">
				...
				<a href="<?php echo site_url('helpAbout/index'); ?>" class="app-sidebar-link active" title="Help and About">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
						...
						<div>
							<div class="card text-center">
								<div class="card-body">
									...
									<p class="card-text">First, make sure that your question is on-topic for this site.</p>
									<p class="card-text">You should only ask practical, answerable questions based on actual problems that you face. Chatty, open-ended questions diminish the usefulness of our site and push other questions off the front page.</p>
									<p class="card-text">Your questions should be reasonably scoped. If you can imagine an entire book that answers your question, you're asking too much. </p>
									<p class="card-text">If your question is about the site itself, please don't ask it here. </p>
								</div>
							</div>
						</div>
						<div>
							<div class="card text-center">
								<div class="card-body">
									...
									<p class="card-text">TechInquireHub is for professional and enthusiast programmers, or anyone who writes code because they love it.</p>
									<p class="card-text">The best TechInquireHub questions generally have a bit of source code in them, but if your question generally covers…</p>
										<ul>
											<li>a specific programming problem, or</li>
											<li>a software algorithm, or</li>
											<li>software tools commonly used by programmers; and is</li>
											<li>a practical, answerable problem that is unique to software development</li>
										</ul>
									<p class="card-text">…then you're in the right place to ask your question!</p>
								</div>
							</div>
						</div>
						<div>
							<div class="card text-center">
								<div class="card-body">
									...
									<p class="card-text">First, make sure you've asked a good question. To get better answers, you may need to put additional effort into your question. </p>
									<p class="card-text">Edit your question to provide status and progress updates. Document your own continued efforts to answer your question.</p>
									<p class="card-text">This will naturally bump your question to the homepage and get more people interested in it.</p>
									<p class="card-text"></p>
									<p class="card-text"></p>
								</div>
							</div>
						...
						<div>
							<div class="card text-center">
								<div class="card-body">
									...
									<p class="card-text">A tag is a word or phrase that describes the topic of the question. </p>
									<p class="card-text">Tags are a means of connecting experts with questions they will be able to answer by sorting questions into specific, well-defined categories.</p>
									<p class="card-text">Tags can also be used to help you identify questions that are interesting or relevant to you.</p>
									<p class="card-text">Clicking on a tag below a question brings you to a page that shows all questions within that tag. </p>
									<p class="card-text"></p>
								</div>
							</div>
						</div>
						<div>
							<div class="card text-center">
								<div class="card-body">
									...
									<p class="card-text">Thanks for taking the time to write an answer. It's because of helpful people like yourself that we're able to learn together as a community. Here are a few tips on how to make your answer great:</p>
									<p class="card-text">What is the question asking for? Make sure your answer provides that - or at least a viable alternative. Your answer can say “don't do that,” but it should also say “try this instead.” </p>
									<p class="card-text">Links to external resources are encouraged, but please add context around the link so your fellow users will have some idea what it is and why it's there.</p>
									<p class="card-text">Vote up the answers that helped you the most!</p>
								</div>
							</div>
						</div>
						<div>
							<div class="card text-center">
								<div class="card-body">
									...
									<p class="card-text">Plagiarism - posting the work of others with no indication that it is not your own - is frowned on by our community, and may result in your content being downvoted or deleted. This includes content generated by humans, as well as generative artificial intelligence tools</p>
									<p class="card-text">If you copy content that you did not create, make sure you do all of the following:</p>
									<ul>
											<li>Provide a link to the original page or answer</li>
											<li>Quote only the relevant portion</li>
											<li>Provide the name of the original author</li>
										</ul>
								</div>
							</div>
						</div>
						<div>
							<div class="card text-center">
								<div class="card-body">
									...
									<p class="card-text">ou can use tags in a number of different ways to find specific questions that interest you.</p>
									<p class="card-text">Every question asked on our site is tagged with the primary topics that the question is about. To find questions about a particular topic on the site, you can visit the Tags page and either browse through popular tags or search for a specific one.</p>
									<p class="card-text">Clicking a tag - from anywhere on the site (whether it's from the tag page or from the tags below a question) - will show you a list of all questions with that tag. </p>
								</div>
							</div>
						</div>
						<div>
							<div class="card text-center">
								<div class="card-body">
									...
									<p class="card-text">Voting is central to our model of providing quality questions and answers; it is how …</p>
									<ul>
										<li>...good content rises to the top</li>
										<li>...incorrect content falls to the bottom</li>
										</ul>
									<p class="card-text">Voting up a question or answer signals to the rest of the community that a post is interesting, well-researched, and useful, while voting down a post signals the opposite: that the post contains wrong information, is poorly researched, or fails to communicate information. </p>
									<p class="card-text"></p>
								</div>
							</div>
						</div>
